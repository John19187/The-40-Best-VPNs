...
| 套餐周期 | 周期支付总价 | 支持设备数 | 核心适用场景 | 标签评级 |
| --- | --- | --- | --- | --- |
| **1 Week (周付)** | ¥34.33 / 周 | 3 台 | 短期跨国出差、临时应急解锁 | 灵活试用 |
| **1 Month (月付)** | ¥89.37 / 月 | 3 台 | 月度轻量使用、短期观影需求 | 基础入门 |
| **3 Month (季付)** | ¥206.33 / 季 | 3 台 | 常规翻墙办公、持续追剧与 AI 调用 | **Most Popular (最高人气)** |
| **1 Year (年付)** | **¥584.73 / 年** | 3 台 | 全天候隐私挂机、工作室或家庭共享 | **Best Value (极致性价比)** |
